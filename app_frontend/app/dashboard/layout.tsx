...
const allNavItems = [
  ...
  { href: "/dashboard/admin/clientes", label: "Clientes", icon: User, rol: "admin" },
...
const pageInfo: Record<string, { title: string; subtitle: string }> = {
  ...
  "/dashboard/admin/clientes": { title: "Clientes", subtitle: "Envía promociones y gestiona tus clientes" },
